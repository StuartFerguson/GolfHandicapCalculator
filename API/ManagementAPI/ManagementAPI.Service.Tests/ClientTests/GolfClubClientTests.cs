namespace ManagementAPI.Service.Tests.ClientTests
{
    ...
    public class GolfClubClientTests
    {
        ...
        public async Task GolfClubClient_AddMeasuredCourseToGolfClub_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                                Type exceptionType,
                                                                                                Type innerExceptionType)
        {
            ...
            Exception exception = Should.Throw(async () =>
                                               {
                                                   await client.AddMeasuredCourseToGolfClub(passwordToken,
                                                                                            GolfClubTestData.AggregateId,
                                                                                            GolfClubTestData.AddMeasuredCourseToClubRequest,
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_AddTournamentDivision_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                          Type exceptionType,
                                                                                          Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception = Should.Throw(async () =>
                                               {
                                                   await client.AddTournamentDivision(passwordToken,
                                                                                      GolfClubTestData.AggregateId,
                                                                                      GolfClubTestData.AddTournamentDivisionToGolfClubRequest,
                                                                                      CancellationToken.None);
                                               },
                                               exceptionType);
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_CreateGolfClub_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                   Type exceptionType,
                                                                                   Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception =
                Should.Throw(async () => { await client.CreateGolfClub(passwordToken, GolfClubTestData.CreateGolfClubRequest, CancellationToken.None); }, exceptionType);
        ...
        public async Task GolfClubClient_CreateGolfClub_SuccessfulResponse()
        {
            ...
            CreateGolfClubResponse response = await client.CreateGolfClub(passwordToken, GolfClubTestData.CreateGolfClubRequest, CancellationToken.None);
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_CreateMatchSecretary_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                         Type exceptionType,
                                                                                         Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception = Should.Throw(async () =>
                                               {
                                                   await client.CreateMatchSecretary(passwordToken,
                                                                                     GolfClubTestData.AggregateId,
                                                                                     GolfClubTestData.CreateMatchSecretaryRequest,
                                                                                     CancellationToken.None);
                                               },
                                               exceptionType);
        ...
        public async Task GolfClubClient_CreateMatchSecretary_SuccessfulResponse()
        {
            ...
            await client.CreateMatchSecretary(passwordToken, GolfClubTestData.AggregateId, GolfClubTestData.CreateMatchSecretaryRequest, CancellationToken.None);
        }
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_GetGolfClubMembersList_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                           Type exceptionType,
                                                                                           Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception = Should.Throw(async () =>
                                               {
                                                   await client.GetGolfClubMembershipList(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None);
                                               },
                                               exceptionType);
        ...
        public async Task GolfClubClient_GetGolfClubMembersList_SuccessfulResponse()
        {
            ...
            fakeHttpMessageHandler.Setup(f => f.Send(It.IsAny<HttpRequestMessage>())).Returns(new HttpResponseMessage
                                                                                              {
                                                                                                  ...
                                                                                                  Content =
                                                                                                      new StringContent(JsonConvert
                                                                                                                            .SerializeObject(GolfClubMembershipTestData
                                                                                                                                                 .GetGolfClubMembershipDetailsResponse()))
                                                                                              });
            ...
            List<GetGolfClubMembershipDetailsResponse> response =
                await client.GetGolfClubMembershipList(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None);
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_GetGolfClubUserList_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                        Type exceptionType,
                                                                                        Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception = Should.Throw(async () => { await client.GetGolfClubUserList(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None); },
                                               exceptionType);
        ...
        public async Task GolfClubClient_GetGolfClubUserList_SuccessfulResponse()
        {
            ...
            GetGolfClubUserListResponse response = await client.GetGolfClubUserList(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None);
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_GetMeasuredCourses_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                       Type exceptionType,
                                                                                       Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception = Should.Throw(async () => { await client.GetMeasuredCourses(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None); },
                                               exceptionType);
        ...
        public async Task GolfClubClient_GetMeasuredCourses_SuccessfulResponse()
        {
            ...
            GetMeasuredCourseListResponse measuredCourses = await client.GetMeasuredCourses(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None);
            ...
            measuredCourses.MeasuredCourses.First().StandardScratchScore
                           .ShouldBe(GolfClubTestData.GetMeasuredCourseListResponse.MeasuredCourses.First().StandardScratchScore);
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_GetSingleGolfClub_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                      Type exceptionType,
                                                                                      Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
            ...
            Exception exception = Should.Throw(async () => { await client.GetSingleGolfClub(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None); },
                                               exceptionType);
        ...
        public async Task GolfClubClient_GetSingleGolfClub_SuccessfulResponse()
        {
            ...
            GetGolfClubResponse response = await client.GetSingleGolfClub(passwordToken, GolfClubTestData.AggregateId, CancellationToken.None);
        ...
        [InlineData(HttpStatusCode.InternalServerError, typeof(Exception), typeof(Exception))]
        [InlineData(HttpStatusCode.BadGateway, typeof(Exception), typeof(Exception))]
        public async Task GolfClubClient_RegisterGolfClubAdministrator_FailedHttpCall_ErrorThrown(HttpStatusCode statusCode,
                                                                                                  Type exceptionType,
                                                                                                  Type innerExceptionType)
        {
            Mock<FakeHttpMessageHandler> fakeHttpMessageHandler = new Mock<FakeHttpMessageHandler>
