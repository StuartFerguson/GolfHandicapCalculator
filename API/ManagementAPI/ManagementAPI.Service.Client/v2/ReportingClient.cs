namespace ManagementAPI.Service.Client.v2
{
    ...
    public class ReportingClient : ClientProxyBase, IReportingClient
    {
                                                                                             ...
                                                                                             CancellationToken cancellationToken)
        {
            ...
            String requestUri = $"{this.BaseAddress}/api/reports/golfclubs/{golfClubId}/membershandicaplist";
                                                                                                               ...
                                                                                                               CancellationToken cancellationToken)
        {
            ...
            String requestUri = $"{this.BaseAddress}/api/reports/golfclubs/{golfClubId}/numberofmembersbyagecategory";
                                                                                                                         ...
                                                                                                                         CancellationToken cancellationToken)
        {
            ...
            String requestUri = $"{this.BaseAddress}/api/reports/golfclubs/{golfClubId}/numberofmembersbyhandicapcategory";
                                                                                                             ...
                                                                                                             CancellationToken cancellationToken)
        {
            ...
            String requestUri = $"{this.BaseAddress}/api/reports/golfclubs/{golfClubId}/numberofmembersbytimeperiod/{timePeriod}";
                                                                                     ...
                                                                                     CancellationToken cancellationToken)
        {
            ...
            String requestUri = $"{this.BaseAddress}/api/reports/golfclubs/{golfClubId}/numberofmembers";
                                                                   ...
                                                                   CancellationToken cancellationToken)
        {
            ...
            String requestUri = $"{this.BaseAddress}/api/reports/players/{playerId}/scores?numberofscores={numberOfScores}";
