namespace ManagementAPI.Service.IntegrationTests.ClientTests
{
    ...
    public class GolfClubClientTests : IClassFixture<ManagmentApiWebFactory<Startup>>
    {
        ...
        public async Task GolfClubClient_AddTournamentDivision_TournamentDivisionIsCreated()
        {
            ...
            // 2. Act
            AddTournamentDivisionToGolfClubResponse addTournamentDivisionToGolfClubResponse =
                await golfClubClient.AddTournamentDivision(token, TestData.GolfClubId, addTournamentDivisionToGolfClubRequest, CancellationToken.None);
        ...
        public async Task GolfClubClient_GetGolfClubMembershipList_GolfClubMembershipListReturned()
        {
            ...
            // 2. Act
            List<GolfClubMembershipDetailsResponse> getClubMembershipDetailsResponses =
                await golfClubClient.GetGolfClubMembershipList(token, TestData.GolfClubId, CancellationToken.None);
        ...
        [Fact]
        public async Task GolfClubClient_GetGolfClubTournaments_TournamentListReturned()
        {
            // 1. Arrange
            HttpClient client = this.WebApplicationFactory.AddGolfClubAdministrator().CreateClient();
            Func<String, String> resolver = api => "http://localhost";
            ...
            // 2. Act
            List<TournamentResponse> tournamentList = await golfClubClient.GetGolfClubTournamentList(token, TestData.GolfClubId, CancellationToken.None);

            // 3. Assert
            tournamentList.ShouldNotBeNull();
            tournamentList.ShouldNotBeEmpty();
            tournamentList.Count.ShouldBe(1);
        }
        ...
        [Fact]
        public async Task GolfClubClient_CreateTournament_TournamentIsCreated()
        {
            // 1. Arrange
            HttpClient client = this.WebApplicationFactory.AddGolfClubAdministrator().CreateClient();
            Func<String, String> resolver = api => "http://localhost";
            ...
            // 2. Act
            CreateTournamentResponse createTournamentResponse = await golfClubClient.CreateTournament(token, TestData.GolfClubId, TestData.CreateTournamentRequest, CancellationToken.None);
        ...
        [Fact]
        public async Task GolfClubClient_CancelTournament_TournamentIsCancelled()
        {
            // 1. Arrange
            HttpClient client = this.WebApplicationFactory.AddGolfClubAdministrator().CreateClient();
            Func<String, String> resolver = api => "http://localhost";
            ...
            // 2. Act
            await golfClubClient.CancelTournament(token, TestData.GolfClubId, TestData.TournamentId, TestData.CancelTournamentRequest, CancellationToken.None);
        }

        [Fact]
        public async Task GolfClubClient_CompleteTournament_TournamentIsCompleted()
        {
            // 1. Arrange
            HttpClient client = this.WebApplicationFactory.AddGolfClubAdministrator().CreateClient();
            Func<String, String> resolver = api => "http://localhost";
            ...
            // 2. Act
            await golfClubClient.CompleteTournament(token, TestData.GolfClubId, TestData.TournamentId, CancellationToken.None);
        }
