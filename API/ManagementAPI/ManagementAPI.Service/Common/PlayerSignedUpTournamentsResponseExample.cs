namespace ManagementAPI.Service.Common
{
    ...
    public class PlayerSignedUpTournamentsResponseExample : IExamplesProvider<PlayerSignedUpTournamentsResponse>
    {
        public PlayerSignedUpTournamentsResponse GetExamples()
        {
